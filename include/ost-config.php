...
define('SECRET_SALT','0nTRFgGbU1qcxbZ8BC_0OSGVYi8yB0Ft');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','holkarnilam14@gmail.com');
...
define('DBNAME','osticketss');
define('DBUSER','osticketss');
define('DBPASS','AllUsers@123');
...
define('TRUSTED_PROXIES', $__SERVER['HTTP_X_FORWARDED_FOR']);
